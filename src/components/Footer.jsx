...
<footer className="mt-auto w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 mx-auto">
  <div className="text-center">
    <div>
      <a className="flex-none text-xl font-semibold text-black dark:text-white" href="#" aria-label="Brand">  <h1 className="w-2/12 text-3xl">
    ...
    <div className="mt-3">
      ...
      <p className="text-gray-500 dark:text-neutral-500">© XFitness. 2022 Htmlstream. All rights reserved.</p>
    </div>
